...
LEFT JOIN trantech.tm_sends 
  ON trantech.tm_sends.serial_id = trantech.tm_product_transactions.serial_id
LEFT JOIN trantech.um_user_trucks 
  ON trantech.um_user_trucks.user_truck_id = trantech.tm_sends.user_truck_id
LEFT JOIN trantech.um_users 
  ON trantech.um_users.user_id = trantech.um_user_trucks.user_id
LEFT JOIN trantech.um_employees 
  ON trantech.um_employees.employee_id = trantech.um_users.people_id
LEFT JOIN trantech.mm_trucks 
  ON trantech.mm_trucks.id = trantech.um_user_trucks.truck_id
...
GROUP BY trantech.tm_product_transactions.serial_id
